...
- [`referrer-policy()`](https://drafts.csswg.org/css-values-5/#funcdef-request-url-modifier-referrer-policy) for `<request-url-modifier>` (dangling)
- [`repeat()`](https://drafts.csswg.org/css-gaps-1/#funcdef-repeat-line-color-repeat) for `<auto-repeat-line-color>,<auto-repeat-line-style>,<auto-repeat-line-width>,<repeat-line-color>,<repeat-line-style>,<repeat-line-width>` (dangling)
- [`repeat()`](https://drafts.csswg.org/css-grid-2/#funcdef-track-repeat-repeat) for `<auto-repeat>,<fixed-repeat>,<track-repeat>` (dangling)
...
- [`font-src-list`](https://drafts.csswg.org/css-fonts-4/#typedef-font-src-list) (dangling)
...
- [`segment-options`](https://drafts.csswg.org/css-values-5/#typedef-calc-interpolate-segment-options) for `calc-interpolate(),color-interpolate(),interpolate(),transform-interpolate()` (dangling)
...
- [`unicode-range-token`](https://drafts.csswg.org/css-syntax-3/#typedef-unicode-range-token) (dangling)
